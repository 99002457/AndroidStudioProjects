...
public class internalstorage extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_internalstorage, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button btn1=(Button)view.findViewById(R.id.button3);
        Button btn2=(Button)view.findViewById(R.id.button4);
